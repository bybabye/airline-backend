...
export const addUser = (req, res) => { // thêm mới chuyến bay dành cho admin
    ...
    const query = `INSERT INTO khachhang ( tenkh, ngaysinh, cmnd , noicap,quoctich,ngonngu)
    SELECT '${data.tenkh}', '${data.ngaysinh}','${data.cmnd}','${data.noicap}' , ${data.quoctich},${data.ngonngu},${data.gmail}
    WHERE NOT EXISTS (
